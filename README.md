# CR Identicon
An identicon icon generator in both C and Rust (CR). I made this for use in my website, it really is a nice way of providing a default user profile image (that does not look boring). There are probably better libraries out there but I just wanted to build it myself.
...
Where most libraries do diverge is the effective rendering, some use squares, some more distinct forms, this library uses squares.
